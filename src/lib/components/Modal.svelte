...
{#if show}
	<div class="fixed inset-0 z-50 flex items-center justify-center">
		...
		<div
			...
			class="relative bg-white dark:bg-[#1c1c1e] rounded-2xl shadow-2xl w-full max-w-lg mx-4 flex flex-col max-h-[90vh] border border-slate-200 dark:border-white/5"
		>
			<div
				class="flex items-center justify-between px-6 py-4 border-b border-slate-100 dark:border-white/5"
			>
